...
namespace VacationRental.Api.Tests
{
    ...
    public class PostBookingTests
    {
        ...
        [Fact]
        public async Task GivenCompleteRequestWithPreparationDays_WhenPostBooking_ThenAGetReturnsTheCreatedBooking()
        {
            var postRentalRequest = new RentalBindingModel
            {
                Units = 1,
        ...
        [Fact]
        public async Task GivenCompleteRequestWithPreparationDays_WhenPostBooking_ThenAPostReturnsErrorWhenThereIsOverbooking()
        {
            var postRentalRequest = new RentalBindingModel
            {
                Units = 1,
